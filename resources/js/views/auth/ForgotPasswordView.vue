...
async function submit() {
    ...
    if (!response.ok) {
        error.value = data.message || "Não foi possível enviar o link.";
        return;
    }
        ...
        <v-card
            ...
            ><div class="auth-banner pa-7 text-center">
                <div class="auth-icon mx-auto mb-4">
                    <v-icon icon="mdi-lock-reset" size="29" />
                </div>
                <div class="text-overline font-weight-bold">LAR & PATAS</div>
                <h1 class="text-h4 font-weight-bold mt-1">Redefinir senha</h1>
            ...
            <v-card-text class="pa-6 pa-md-8"
                ...
                ><v-form @submit.prevent="submit"
                    ><v-text-field
                        ...
                        block
                        rounded="lg"
                        >Enviar link de redefinição<v-icon
                            end
                            icon="mdi-send" /></v-btn
                ></v-form>
