...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('chat/conversations/{conversation}/read', [DirectMessageController::class, 'read']);
    ...
    Route::post('profile/pets', [ProfileController::class, 'storeOwnedPet']);
    Route::post('profile/pets/{pet}/owners', [ProfileController::class, 'inviteCaretaker']);
